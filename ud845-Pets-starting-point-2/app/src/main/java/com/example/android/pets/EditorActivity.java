...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet() {
        ...
        if (rowId == -1)
            Toast.makeText(this, rowId+"Error occured while saving pet", Toast.LENGTH_LONG).show();
        else
            Toast.makeText(this, rowId+" pet saved successfully", Toast.LENGTH_LONG).show();
    }
    @Override
